...
trainer = Trainer(diffusion_model=diffusion_model,
                  folder="/jet/home/lisun/work/r3/results/text_embedding_192_standard",
                  ema_decay=0.995,
                  num_frames=64,
                  train_batch_size=1,
                  train_lr=1e-4,
                  ...
                  update_ema_every=10,
                  save_and_sample_every=1000,
                  results_folder='/ocean/projects/asc170022p/yanwuxu/diffusion/video-diffusion-pytorch/video_diffusion_pytorch/results_text_low_res_improved_unet_seg_standard_text',
                  save_folder='./results/img_64_standard_bulk/',
                  num_sample_rows=1,
                  num_sample=1,
                  max_grad_norm=1.0)
