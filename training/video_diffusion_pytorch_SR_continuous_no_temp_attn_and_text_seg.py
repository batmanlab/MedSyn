...
class GaussianDiffusion(nn.Module):
    ...
    def sample(self, img_lr=None, cond=None, cond_scale=1., batch_size=16, DDIM=True):
        ...
        image_size = 128#self.image_size
...
class Trainer(object):
    def __init__(
        ...
        #                         'text': os.path.join("/ocean/projects/asc170022p/lisun/r3/results/text_embedding_192", img_dir.replace("nii.gz", "npy"))})
        ...
        for img_dir in os.listdir("/ocean/projects/asc170022p/lisun/r3/results/moved_img_nii_seg_lobe_256_v2"):
            train_files.append({"image": os.path.join(folder, img_dir),
                                "lobe": os.path.join(
                                    ...
                                    img_dir),
                                "airway": os.path.join(
                                    "/ocean/projects/asc170022p/lisun/r3/results/moved_img_nii_seg_airway_256_label_v3",
                                    img_dir),
                                "vessel": os.path.join(
        ...
        self.ds = cache_transformed_train_data_aug_seg(shape=[image_size, image_size, image_size], crop_shape=[image_size, 72, 72],
                                               train_files=train_files)  # Dataset(folder, image_size, channels = channels, num_frames = num_frames)
